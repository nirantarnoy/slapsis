...
?>
<div class="user-index space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">จัดการข้อมูลผู้ใช้งานระบบ</p>
        </div>
        ...
        <?= GridView::widget([
            ...
            'columns' => [
                ...
                [
                    ...
                    'headerOptions' => ['class' => 'px-3 py-3'],
                    'contentOptions' => ['class' => 'px-3 py-3 text-gray-600'],
                    'value' => function ($data) {
                ...
                [
                    ...
                    'buttons' => [
                        ...
                        'delete' => function ($url, $data, $index) {
                            return $data->id == 1 ? '' : Html::a('<i class="fas fa-trash"></i>', 'javascript:void(0)', [
