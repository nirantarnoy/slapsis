...
?>
<div class="tiktok-income-index space-y-8">

    <!-- Header -->
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-800 flex items-center gap-2">
                <span class="inline-flex items-center justify-center w-8 h-8 rounded-full bg-black text-white">
                    <i class="fab fa-tiktok text-sm"></i>
                </span>
                <?= Html::encode($this->title) ?>
            </h1>
            <p class="text-sm text-gray-500 mt-1 ml-10">สรุปรายได้และค่าธรรมเนียมจาก TikTok Shop</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="form-group">
                ...
                <?= $form->field($searchModel, 'order_id', ['options' => ['class' => 'm-0']])->textInput([
